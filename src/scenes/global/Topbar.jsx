...
export default function Topbar({venderdetail}) {
  return (
                ...
                <div className="bg-s">
                    <div className="flex-col flex">
                        <div className="w-full border-b-2 border-gray-200">
                            <div className="bg-slate-700 h-16 justify-between items-center mx-auto px-4 flex">
                                <div>
                                    <img
...
{/*  */}
<SelectStore stores={venderdetail.shops}/>
                    ...
                    absolute -top-px -right-1"
                                    ...
                                    <div className="justify-center items-center flex relative">
                                        <img
                                            ...
                                            alt=""
                                        />
                                        <p className="font-semibold text-sm">{venderdetail.name}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
